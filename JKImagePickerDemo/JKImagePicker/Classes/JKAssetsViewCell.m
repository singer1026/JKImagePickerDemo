...
//        UIImage  *imgH = [UIImage imageNamed:@"photo_check_selected"];
        ...
        [_checkButton setBackgroundImage:img forState:UIControlStateSelected];
...
//        [_photoButton setBackgroundImage:bgImg forState:UIControlStateNormal];
//        [_photoButton setBackgroundImage: [UIImage imageWithColor:[UIColor blackColor]] forState:UIControlStateNormal];
